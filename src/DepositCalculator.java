...
public class DepositCalculator {
    ...
    double calculateComplexPercent(double amount, double depositPeriod) {
        double pay = amount * Math.pow(1.005, 12 * depositPeriod);
        return calculateAmount(pay);
    }

    double calculateSimplePercent(double amount, double depositPeriod) {
